#!/usr/bin/env python
# coding: utf-8
# Copyright 2013 Abram Hindle, Tyler Davidson
#
...
# I give this to you, this is how you get the
# raw body/data portion of a post in flask
...
def flask_post_json():
    ...
    if (request.json is not None):
        return request.json
    elif (request.data is not None and request.data is not ''):
